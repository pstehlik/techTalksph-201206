			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="twit.user.label" default="User" /></th>
				...
				<g:each in="${twitInstanceList}" status="i" var="twitInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${twitInstance.id}">${fieldValue(bean: twitInstance, field: "text")}</g:link></td>
					
						<td>${fieldValue(bean: twitInstance, field: "user")}</td>
